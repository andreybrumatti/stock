...
class IncreaseStockProductServiceTest {
    ...
    @InjectMocks
    private  IncreaseStockProductService increaseStockProductService;
    ...
    @Test
    @DisplayName("Should throw type movement exception case typeMovement value is different from IN")
    void shouldThrowTypeMovementException() {
        ...
        assertThrows(TypeMovementException.class, () -> {
            increaseStockProductService.increaseStock(productId, movementStockCommandException);
        });
    }

    @Test
    @DisplayName("Should increase in product stock with success")
    void shouldIncreaseInProductStock() {
        ...
        StockMovement stockMovementSave = increaseStockProductService.increaseStock(productId, movementStockCommand);
        ...
        assertEquals(5, stockMovementSave.getProduct().getCurrentStock());
